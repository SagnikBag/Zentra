...
const Cart = () => {
    ...
    const { handleGetCart, handleUpdateQuantity, handleRemoveItem, handleClearCart, handleIncrementCartItem } = useCart();
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                        ...
                        <div className="lg:col-span-4 sticky top-24">
                            <div className="bg-[#191f31] border border-[#2e3447] rounded-2xl p-6 shadow-2xl relative overflow-hidden">
                                ...
                                <button
                                    onClick={() => alert(`Proceeding to checkout with total amount: ${formatCurrency(grandTotal)}`)}
